...
#================================================
    ...
    def load_scene_points_raw(self, label, intrinsics_old):
        ...
        try:
            ...
            points_dir = label["points"].rsplit("/", 1)[0]#保存的是点云(X, Y, Z, 语义值)
    ...
    def load_scene_tokens(self, label, scene_points_raw):
        points = scene_points_raw.clone()
    ...
    def __getitem__(self, index: int) -> Dict:
        ...
        data_dict["scene_tokens"] = self.load_scene_tokens(label, data_dict["scene_points_raw"])
...
def collate_fn_pedmotion(data):
    ...
    ret_dict = {
        ...
        "gt_traj_150": torch.stack(gt_traj_150_batch),
        "gt_traj_150_mask": torch.stack(gt_traj_150_mask_batch),
